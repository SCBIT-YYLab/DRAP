...
####################################################################################################
#' @name RelativeChange
#' @title Caculate the relative change of tumor volume data or body weight data.
#' @description Caculate the relative change of tumor volume data or body weight data based on the baseline.
...
#' 
#' @export
plotVolumeGC <- function(data, level = c('Animal','Arm'), pattern = c("OneAN", "TAN"), 
...
#' 
#' @export
plotBWeightGC <- function(data, level = c('Animal','Arm'), pattern = c("OneAN", "TAN"), 
                          orders = NULL, position.dodge, ...){
...
#' 
#' @details compareGC does pairwise comparisons of growth curves between all pairwise arms, or compared to negative/posative arm . p-values can be obtained with permutation test.
#' 
...
#' \item{Arm1}{name of first arm in a comparison;}
#' \item{Arm2}{name of second arm in a comparison;}
#' \item{Stat}{observed value of the statistic;}
#' \item{p.value}{estimated p-value;}
#' \item{q.value}{p-value adjusted for multiple testing.}
#' 
...
#' 
#' @export
plotDRLevel <- function(data, by = c("Arms", "Tumor"), pattern = c("oneAN",'TAN'), 
                        orders=NULL, orders.1=NULL, orders.2=NULL, ...){
